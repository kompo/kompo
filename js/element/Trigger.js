export default class Trigger {
    ...
    axiosRequestAction(){
        ...
        axios({
            ...
            headers: Object.assign(
                ...
                this.included ? { 'X-Vuravel-Includes': this.included} : {}
            )
        }).then(response => {
    ...
    refreshCatalogAction(){
        this.vue.$_state({ loading: true })
        this.vue.$vuravel.vlRefreshCatalog(this.vuravelid || this.vue.vuravelid, this.page)
    }
    submitFormAction(){
        ...
        axios({
            ...
            headers: Object.assign(
                {'X-Vuravel-Id': this.vue.vuravelid}, 
                this.handle ? {'X-Vuravel-Handle': this.handle} : {}
            )
        }).then(response => {
