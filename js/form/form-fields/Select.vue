    ...
    <vl-form-field v-bind="$_wrapperAttributes">
        ...
        <div v-if="filteredOptions.length" class="vlOptions">
            <div v-for="(option,key) in filteredOptions" :key="key"
                ...
                <vlCustomLabel :vcomponent="option.label" :vuravelid="vuravelid" />
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        $_emptyValue() { return [] },
        ajaxOptions(){ return this.ajaxOptionsRoute && this.ajaxOptionsMethod },
        ajaxOptionsMethod(){ return this.$_data('ajaxOptionsMethod') },
        ajaxOptionsRoute(){ return this.$_data('ajaxOptionsRoute') },
    ...
    methods: {
        ...
        loadOptionsByAjax(){
            ...
            if(this.ajaxOptionsFromField){
                ...
                this.$vuravel.vlDeliverJsonFormData(this.vuravelid, this.$_elementId())
