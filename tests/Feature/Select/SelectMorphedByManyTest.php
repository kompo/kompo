...
class SelectMorphedByManyTest extends SelectEnvironmentBootManyTest
{
    ...
    {
    	$this->assert_crud_many_selects(_SelectMorphedByManyForm::class, 'morphedByManyPlain', 'morphed_by_many_plain', 0);
    }
    
    /** @test */
    public function select_works_with_morphed_by_many_ordered_crud()
    {
    	$this->assert_crud_many_selects(_SelectMorphedByManyForm::class, 'morphedByManyOrdered', 'morphed_by_many_ordered', 1);
    }
    
    /** @test */
    public function select_works_with_morphed_by_many_filtered_crud()
    {
    	$this->assert_crud_many_selects(_SelectMorphedByManyForm::class, 'morphedByManyFiltered', 'morphed_by_many_filtered', 2);
    }
